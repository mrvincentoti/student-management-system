...
class CourseController extends Controller
{
  ...
  {
    $class_id = \Auth::user()->course_id;
    $level = \Auth::user()->level;
    $courses = $this->courseService->getCoursesByClassAndLevel($class_id, $level);
    $dept = Classes::find($class_id)->first();
    $section = Section::all()->where('class_id', $class_id);
  ...
  {
    $courses = $this->courseService->getCoursesBySectionCustom($request->semester_id, \Auth::user()->level);
