            ...
            <table class="table table-condensed table-hover">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <input type="number" class="form-control input-sm" id="assignment" name="assignment_percent" placeholder="@lang('Percentage')" max="50" value="{{$grade->course->assignment_percent}}">
                  </td>
                  <td>
