    ...
    <h3>{{$user->name}} <span class="badge badge-danger">{{ucfirst($user->role)}}</span> <span class="badge badge-primary">{{ucfirst($user->gender)}}</span>
      ...
      @if($user->role == "student")
       ...
       <div class="row">
        ...
        <div class="row">
          <div class="col-md-12">
            <h6 class="bg-success" style="text-align:center; color: #ffffff;">
              @lang('Academic Information')
            </h6>
            <div class="col-xs-9 table-responsive">
              <table class="table table-bordered table-striped">
                <tr style="font-size: 14px;">
                  <td>@lang('Matric Number'):</td>
                ...
                <tr style="font-size: 14px;">
                  <td>@lang('Session'):</td>
                  <td colspan="3">@isset($user->session){{$user->session}}@endisset</td>
                </tr>
              </table>
            </div>
            <!-- <div class="col-xs-3">
          ...
          <div class="col-md-12">
            ...
            <div class="col-xs-12">
              <table class="table table-bordered table-striped">
                ...
                <tr style="font-size: 14px;">
                  <td>@lang('Religion'):</td>
                  <td>@isset($user->religion){{$user->religion}}@endisset</td>
                  <td>@lang('Father Name'):</td>
                  <td>@isset($user->sponsor_name){{$user->sponsor_name}}@endisset</td>
                </tr>
                <tr style="font-size: 14px;">
                ...
                <tr style="font-size: 14px;">
                  ...
                  <td>{{$user->phone_number}}</td>
                  <td>@lang('Sponsor\'s Phone Number'):</td>
                  <td>@isset($user->sponsor_phone){{$user->sponsor_phone}}@endisset</td>
                </tr>
                <!-- <tr style="font-size: 14px;">
