<form class="form-horizontal" action="{{url('exams/create')}}" method="post">
    {{ csrf_field() }}
    <div class="form-row">
        <div class="form-group{{ $errors->has('term') ? ' has-error' : '' }} col-md-6">
            <label for="term" class="col-md-4 control-label">@lang('Terms')</label>
            <div class="col-md-12">
                <select id="term" class="form-control" name="term">
                <option value="1">@lang('First Semester')</option>
                <option value="2">@lang('Second Semester')</option>
        ...
        <div class="form-group{{ $errors->has('exam_name') ? ' has-error' : '' }} col-md-6">
