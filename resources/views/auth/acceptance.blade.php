        ...
        <div class="row clearfix">
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
              ...
              <div class="card-body">
                <form id="wizard_with_validation" method="POST" action="{{ route('acceptance-form') }}" enctype="multipart/form-data">
                  {{ csrf_field() }}
                    ...
                    <div class="form-row">
                      ...
                      <div class="form-group form-float col-md-4">
                        <div class="form-line">
                          ...
                          <input type="text" class="form-control" name="othernames" value="{{$applicant->middlename}}" id="othernames">
                        </div>
                      </div>
                    </div>
                    <div class="form-row">
                    ...
                    <div class="form-row">
                      <div class="form-group form-float col-md-12">
                        <div class="form-line">
                          ...
                          <input type="text" name="duration" id="duration" class="form-control" required readonly>
