            ...
            <div class="dropdown-menu dropdown-menu-right pullDown">
                <div class="dropdown-title">{{ Auth::user()->name }}</div>
                 @if(Auth::user()->role != 'master')
                    <a href="{{url('user/'.Auth::user()->student_code)}}" class="dropdown-item has-icon"> <i class="far fa-user"></i> Profile</a>
                 @endif
                 <a href="{{url('user/config/change_password')}}" class="dropdown-item has-icon"> <i class="fas fa-bolt"></i>@lang('Change Password')</a> 
                 @if(env('APP_ENV') != 'production')
                    <a href="{{url('user/config/impersonate')}}" class="dropdown-item has-icon"> <i class="fas fa-cog"></i>
